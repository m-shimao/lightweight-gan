    ...
    def __init__(
        ...
        *,
        ...
        if optimizer == "adam":
            ...
            self.G_opt = AdaBelief(self.G.parameters(), lr = lr, betas=(0.5, 0.999), print_change_log=False, eps=1e-16)
            self.D_opt = AdaBelief(self.D.parameters(), lr = lr * ttur_mult, betas=(0.5, 0.999), print_change_log=False, eps=1e-16)
        else:
